...
namespace Custom.Umbraco.ApiControllers
{
    public class LocationController : UmbracoApiController
    {
        ...
        public string GetLocations()
        {
            ...
            {
                LogHelper.Error(typeof(LocationController), "Error getting location information", e);
                return "Error!";
            }
        }
        ...
        public string GetDefaultLocation()
        {
            ...
            {
                LogHelper.Error(typeof(LocationController), "Error getting default office", e);
                return "Error!";
            }
        }
    }
